...
with open('/Users/noahdonovan/vequil-alpha/web/static/index.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
replacements = [
    ...
    (r"background: var\(--blue\);\n\n            color: var\(--white\);", r"background: #ffffff;\n\n            color: #000000;"),
]

for old, new in replacements:
    content = re.sub(old, new, content)

# Check if hp-pill lost text color
content = re.sub(r"\.hp-pill \{\n\n            font-size: 12px;\n\n            font-weight: 500;\n\n            color: rgba\(15, 23, 42, 0\.6\);",
    r".hp-pill {\n\n            font-size: 12px;\n\n            font-weight: 500;\n\n            color: rgba(15, 23, 42, 0.6);", content)

with open('/Users/noahdonovan/vequil-alpha/web/static/index.html', 'w', encoding='utf-8') as f:
    f.write(content)
